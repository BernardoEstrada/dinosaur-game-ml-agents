...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class BloomEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            var cam = (target as Bloom).GetComponent<Camera>();
            if (cam != null)
            ...
            sepBlurSpread.floatValue =
                EditorGUILayout.Slider(" Sample Distance", sepBlurSpread.floatValue, 0.1f, 10.0f);
            EditorGUILayout.Separator();
            ...
            if (1 == tweakMode.intValue) {
                ...
                lensflareThreshold.floatValue =
                    EditorGUILayout.Slider("Threshold", lensflareThreshold.floatValue, 0.0f, 4.0f);
