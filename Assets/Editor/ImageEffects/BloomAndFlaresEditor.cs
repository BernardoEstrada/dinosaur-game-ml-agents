...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class BloomAndFlaresEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            var cam = (target as BloomAndFlares).GetComponent<Camera>();
            if (cam != null)
            ...
            bloomBlurIterations.intValue =
                EditorGUILayout.IntSlider("Blur iterations", bloomBlurIterations.intValue, 1, 4);
            sepBlurSpread.floatValue = EditorGUILayout.Slider("Blur spread", sepBlurSpread.floatValue, 0.1f, 10.0f);

            if (1 == tweakMode.intValue)
                useSrcAlphaAsMask.floatValue = EditorGUILayout.Slider(
                    new GUIContent("Use alpha mask", "Make alpha channel define glowiness"),
            ...
            if (1 == tweakMode.intValue) {
                ...
                if (lensflares.boolValue) {
                    ...
                    EditorGUILayout.PropertyField(lensFlareVignetteMask,
                        new GUIContent("Lens flare mask", "This mask is needed to prevent lens flare artifacts"));

                    EditorGUILayout.PropertyField(lensflareIntensity, new GUIContent("Local intensity"));
                    lensflarethreshold.floatValue =
                        EditorGUILayout.Slider("Local threshold", lensflarethreshold.floatValue, 0.0f, 1.0f);
                    ...
                    if (lensflareMode.intValue == 0) {
                        ...
                        hollywoodFlareBlurIterations.intValue = EditorGUILayout.IntSlider("Blur iterations",
                            hollywoodFlareBlurIterations.intValue, 1, 4);
