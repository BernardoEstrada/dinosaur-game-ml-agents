...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class VignetteAndChromaticAberrationEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.LabelField("Simulates the common lens artifacts 'Vignette' and 'Aberration'",
            ...
            if (m_Mode.intValue > 0) {
                ...
                m_LuminanceDependency.floatValue = EditorGUILayout.Slider("  Contrast Dependency",
                    m_LuminanceDependency.floatValue, 0.001f, 1.0f);
                m_BlurDistance.floatValue =
                    EditorGUILayout.Slider("  Blur Distance", m_BlurDistance.floatValue, 0.001f, 5.0f);
            }
            else {
