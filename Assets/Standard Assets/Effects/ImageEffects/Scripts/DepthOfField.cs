...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class DepthOfField : PostEffectsBase {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            dofHdrMaterial.SetVector("_CurveParams",
            ...
            if (visualizeFocus) {
                ...
                if (highResolution) {
                    ...
                    dx11bokehMaterial.SetVector("_BokehParams",
                        new Vector4(dx11BokehScale, dx11BokehIntensity, Mathf.Clamp(dx11BokehThreshold, 0.005f, 4.0f),
                            internalBlurWidth));
                ...
                var blurPass = blurSampleCount == BlurSampleCount.High || blurSampleCount == BlurSampleCount.Medium
                    ? 17
                    : 11;
                ...
                if (highResolution) {
                    ...
                    Graphics.Blit(source, destination, dofHdrMaterial,
        ...
        private void CreateComputeResources() {
            ...
            if (cbPoints == null) cbPoints = new ComputeBuffer(90000, 12 + 16, ComputeBufferType.Append);
        }

        private float FocalDistance01(float worldDist) {
            return cachedCamera
                       .WorldToViewportPoint((worldDist - cachedCamera.nearClipPlane) * cachedCamera.transform.forward +
                                             cachedCamera.transform.position).z /
