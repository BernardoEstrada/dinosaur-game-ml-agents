...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class Tonemapping : PostEffectsBase {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            if (source.format != RenderTextureFormat.ARGBHalf) validRenderTextureFormat = false;
#endif
            ...
            var freshlyBrewedInternalRt =
                CreateInternalRenderTexture(); // this retrieves rtFormat, so should happen before rt allocations
            ...
            for (var i = 0; i < downsample; i++) RenderTexture.ReleaseTemporary(rts[i]);
