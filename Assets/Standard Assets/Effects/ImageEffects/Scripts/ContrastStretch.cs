...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class ContrastStretch : MonoBehaviour {
        ...
        [Range(0.0001f, 1.0f)] public float adaptationSpeed = 0.02f;
        ...
        [Range(0.0f, 1.0f)] public float limitMinimum = 0.2f;

        /// The limit on the maximum luminance (0...1) - we won't go below this.
        [Range(0.0f, 1.0f)] public float limitMaximum = 0.6f;
        ...
        private void Start() {
            ...
            if (!shaderAdapt.isSupported || !shaderApply.isSupported || !shaderLum.isSupported ||
