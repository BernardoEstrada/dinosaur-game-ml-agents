...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class ScreenSpaceAmbientOcclusion : MonoBehaviour {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            var rtAO = RenderTexture.GetTemporary(source.width / m_Downsampling, source.height / m_Downsampling, 0);
            ...
            m_SSAOMaterial.SetVector("_NoiseScale",
                new Vector3((float)rtAO.width / noiseWidth, (float)rtAO.height / noiseHeight, 0.0f));
